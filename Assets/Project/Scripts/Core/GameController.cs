...
namespace Project.Scripts.Core
{
    public class GameController : MonoBehaviour
    {
        ...
        [SerializeField] private ChainReactionSystem _chainReactionSystem;
        [SerializeField] private TutorialGuide _tutorialGuide;
        [SerializeField] private PackshotScreen _packshotScreen;
