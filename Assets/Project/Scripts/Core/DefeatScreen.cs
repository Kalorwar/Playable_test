...
namespace Project.Scripts.Core
{
    public class DefeatScreen : MonoBehaviour
    {
        ...
        [SerializeField] private CanvasGroup _defeatGroup;
        ...
        private IEnumerator DefeatRoutine(Action onComplete)
        {
            ...
            yield return _defeatGroup.DOFade(1f, FadeDuration).WaitForCompletion();

            onComplete?.Invoke();
            yield return new WaitForSeconds(DisplayDuration);
            yield return _defeatGroup.DOFade(0f, FadeDuration).WaitForCompletion();
