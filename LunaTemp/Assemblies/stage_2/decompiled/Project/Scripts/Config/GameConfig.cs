...
namespace Project.Scripts.Config
{
	...
	public class GameConfig : ScriptableObject
	{
		...
		[SerializeField]
		private int _splitPoint = 5;

		[Header("Animation")]
		[SerializeField]
		private float _elementFlyDuration = 0.4f;

		[SerializeField]
		private float _elementDisappearDuration = 0.25f;

		[SerializeField]
		private float _dragSnapDuration = 0.2f;

		[SerializeField]
		private float _returnDuration = 0.3f;

		[SerializeField]
		private float _elementJumpHeight = 2f;

		[SerializeField]
		private float _elementFlipAngle = -180f;
		...
		[SerializeField]
		private float _delayBeforePackshot = 0.8f;

		[Header("Tutorial")]
		[SerializeField]
		private float _idleDelay = 1.5f;
